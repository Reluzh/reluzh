...
let imageCounter = 1; // Reset counter
...
export const mockListings: Listing[] = [
  ...
  },
  {
    ...
    isFavorite: false,
    offers: [
      { id: 'o3', name: 'Mixed Vegetable Box', originalPrice: 15.00, discountedPrice: 6.00, quantityLeft: 8, description: 'Slightly imperfect but fresh veggies.' }, // No image for this offer
      { id: 'o4', name: 'Overripe Fruit Bag', originalPrice: 10.00, discountedPrice: 4.00, quantityLeft: 12, description: 'Perfect for smoothies or baking.' }, // No image for this offer
    ],
  },
  {
    id: '3',
    ...
    isFavorite: true,
    offers: [
      { id: 'o5', name: 'End-of-Day Pizza Slices', originalPrice: 4.00, discountedPrice: 1.50, quantityLeft: 15, description: 'Assorted pizza slices.' }, // No image for this offer
    ],
  },
  {
    id: '4',
    ...
    isFavorite: false,
    offers: [
      { id: 'o6', name: 'Artisan Bread Loaves', originalPrice: 7.00, discountedPrice: 3.50, quantityLeft: 7, description: 'Freshly baked artisan bread from the morning.' }, // No image for this offer
    ],
  },
];
