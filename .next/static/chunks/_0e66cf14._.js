...
;
;
const ProfileMenuItem = ({ icon: Icon, label, description, href, isExternal, onClick })=>{
...
function ProfilePage() {
    _s();
    const { user, firestoreUser, loading: authLoading, logoutUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(ProfilePage, "hTEKj+HvRi95XXjRUy+EBWjy2JM=", false, function() {
    return [
...
//# sourceMappingURL=_0e66cf14._.js.map